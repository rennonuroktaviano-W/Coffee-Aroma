...
<div class="relative w-full h-full bg-[#0f0805] overflow-hidden flex items-center justify-center">
    ...
    {{-- Floating Particles (Dark amber tone) --}}
    ...
    <div
        ...
        {{-- CENTER: Americano with Glowing Orb --}}
        <div class="relative flex items-center justify-center py-8">

            {{-- GLOWING ORB (Warm white/amber, menyala) --}}
            <div class="absolute w-[280px] h-[280px] md:w-[320px] md:h-[320px] rounded-full pointer-events-none" style="background: radial-gradient(circle, rgba(255,240,220,0.9) 0%, rgba(255,220,190,0.5) 25%, rgba(200,170,140,0.2) 50%, rgba(180,150,120,0.08) 70%, transparent 80%);
                        filter: blur(18px);
                        animation: glowPulse 3s ease-in-out infinite;">
            </div>
            <div class="absolute w-[340px] h-[340px] md:w-[380px] md:h-[380px] rounded-full pointer-events-none" style="background: radial-gradient(circle, rgba(255,230,200,0.18) 0%, transparent 65%);
                        animation: glowPulse 3s ease-in-out infinite reverse;">
            </div>
            <div class="absolute w-[180px] h-[180px] rounded-full pointer-events-none" style="background: radial-gradient(circle, rgba(255,245,230,0.7) 0%, rgba(255,230,210,0.25) 40%, transparent 70%);
                        filter: blur(10px);
            ...
            {{-- SVG VECTOR AMERICANO (Top View, No Art, Pure Dark) --}}
            <div class="relative z-10 w-[220px] h-[220px] md:w-[260px] md:h-[260px]"
                ...
                <svg viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                    ...
                    {{-- Saucer --}}
                    <ellipse cx="150" cy="155" rx="145" ry="145" fill="#E8E0D8" filter="url(#americanoShadow)" />
